...
def dataloader(train_data, val_data, test_data, batch_size):
    ...
    train_loader = DataLoader(dataset=train_data, batch_size=batch_size, shuffle=True,
                              num_workers=8)
    val_loader = DataLoader(dataset=val_data, batch_size=batch_size//8, shuffle=False,
                            num_workers=8)
    test_loader = DataLoader(dataset=test_data, batch_size=batch_size//8, shuffle=False,
                             num_workers=8)
